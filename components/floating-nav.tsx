    ...
    <>
      ...
      >
        <div className="relative px-4 py-3 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-lg">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/20 to-blue-500/20 rounded-full blur opacity-50"></div>

          {isMobile ? (
            <div className="relative flex items-center justify-between">
              <Link href="/" className="font-bold text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">Hung</span>
                <span className="text-white">gVN</span>
              </Link>
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="relative flex items-center gap-1">
              ...
              <Button
                size="sm"
                className="ml-2 bg-gradient-to-r from-blue-500 to-blue-500 hover:from-blue-500 hover:to-blue-500 border-0"
      ...
      {isMobile && (
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <Button
              className="mt-6 bg-gradient-to-r from-blue-500 to-blue-500 hover:from-blue-500 hover:to-blue-500 border-0"
              onClick={() => window.open("https://www.youtube.com/@hungg", "_blank")}
            >
              <Youtube /> HunggVN
            </Button>
